...
# Домашнее задание к занятию «Введение в Terraform» Теплов Михаил 
...
Было 1nginx — имя ресурса не должно начинаться с цифры, это нарушает синтаксис Terraform.
Ссылка на несуществующее значение пароля
Было ${random_password.random_string_FAKE.resulT} — такого ресурса и атрибута не существует, правильное имя: ${random_password.random_string.result}
Ресурс docker_image без имени
